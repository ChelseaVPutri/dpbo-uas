import 'package:dpbo/models/category_model.dart';
...
class _Homepage extends State<Homepage> {
  ...
  //               children: [
  //                 SvgPicture.asset(newsletter[index].imagePath),
  //                 Column(
  //                   mainAxisAlignment: MainAxisAlignment.center,
  //                   crossAxisAlignment: CrossAxisAlignment.start,
  //                   children: [
  ...
  //                 GestureDetector(
  //                   onTap: () {},
  //                   child: SvgPicture.asset('assets/icons/right-arrow.svg', width: 30, height: 30,),
  //                 )
  //               ],
  //             ),
  //             decoration: BoxDecoration(
  //               color: newsletter[index].boxIsSelected ? Colors.white : Colors.transparent,
  //               borderRadius: BorderRadius.circular(16),
  //               boxShadow: newsletter[index].boxIsSelected ? [
  //                 BoxShadow(
